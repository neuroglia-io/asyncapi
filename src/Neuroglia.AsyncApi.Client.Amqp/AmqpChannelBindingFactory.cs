...
namespace Neuroglia.AsyncApi.Client
{
    ...
    /// </summary>
    public class AmqpChannelBindingFactory
        : IChannelBindingFactory
    {

        /// <summary>
        /// Initializes a new <see cref="AmqpChannelBindingFactory"/>
        /// </summary>
        /// <param name="serviceProvider">The current <see cref="ISerializerProvider"/></param>
        public AmqpChannelBindingFactory(IServiceProvider serviceProvider)
        {
        ...
        public virtual bool SupportsProtocol(string protocol)
        {
            ...
            return protocol.Equals(AsyncApiProtocols.Amqp, StringComparison.OrdinalIgnoreCase);
        }
        ...
        public virtual IChannelBinding CreateBinding(IChannel channel, IEnumerable<KeyValuePair<string, ServerDefinition>> servers)
        {
            ...
            return ActivatorUtilities.CreateInstance<AmqpChannelBinding>(this.ServiceProvider, channel, servers);
        }
