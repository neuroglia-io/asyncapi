...
namespace Neuroglia.AsyncApi.Client.Services
{
    ...
    public interface IAsyncApiClientFactory
    {
        ...
        /// <summary>
        /// Creates a new <see cref="IAsyncApiClient"/>
        /// </summary>
        /// <param name="document">The <see cref="AsyncApiDocument"/> to create a new <see cref="IAsyncApiClientFactory"/> for</param>
        /// <returns>A new <see cref="IAsyncApiClient"/></returns>
        public IAsyncApiClient CreateClient(AsyncApiDocument document);
