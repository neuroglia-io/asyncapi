...
/// <summary>
/// Defines the fundamentals of a service used to handle schemas
/// </summary>
public interface ISchemaHandler
{
    ...
    Task<IOperationResult> ValidateAsync(object graph, object schema, CancellationToken cancellationToken = default);
