    ...
    : IV3ChannelDefinitionBuilder
{
    ...
    /// <inheritdoc/>
    public virtual IV3ChannelDefinitionBuilder WithExternalDocumentation(Action<IExternalDocumentationDefinitionBuilder> setup)
    {
        ArgumentNullException.ThrowIfNull(setup);
    ...
    /// <inheritdoc/>
    public virtual IV3ChannelDefinitionBuilder WithTag(Action<ITagDefinitionBuilder> setup)
    {
        ArgumentNullException.ThrowIfNull(setup);
    ...
    : IV3AsyncApiDocumentBuilder
{
    ...
    /// <inheritdoc/>
    public virtual IV3AsyncApiDocumentBuilder WithTag(Action<ITagDefinitionBuilder> setup)
    {
        ArgumentNullException.ThrowIfNull(setup);
        var builder = ActivatorUtilities.CreateInstance<TagDefinitionBuilder>(this.ServiceProvider);
        setup(builder);
    ...
    /// <inheritdoc/>
    public virtual IV3AsyncApiDocumentBuilder WithExternalDocumentation(Action<IExternalDocumentationDefinitionBuilder> setup)
    {
        ArgumentNullException.ThrowIfNull(setup);
        var builder = ActivatorUtilities.CreateInstance<ExternalDocumentationDefinitionBuilder>(this.ServiceProvider);
        setup(builder);
    ...
    /// <inheritdoc/>
    public virtual IV3AsyncApiDocumentBuilder WithServerVariableComponent(string name, Action<IServerVariableDefinitionBuilder> setup)
    {
        ArgumentException.ThrowIfNullOrWhiteSpace(name);
        ArgumentNullException.ThrowIfNull(setup);
    ...
    /// <inheritdoc/>
    public virtual IV3AsyncApiDocumentBuilder WithCorrelationIdComponent(string name, Action<ICorrelationIdDefinitionBuilder> setup)
    {
        ArgumentException.ThrowIfNullOrWhiteSpace(name);
        ArgumentNullException.ThrowIfNull(setup);
    ...
    /// <inheritdoc/>
    public virtual IV3AsyncApiDocumentBuilder WithExternalDocumentationComponent(string name, Action<IExternalDocumentationDefinitionBuilder> setup)
    {
        ArgumentException.ThrowIfNullOrWhiteSpace(name);
        ArgumentNullException.ThrowIfNull(setup);
        var builder = ActivatorUtilities.CreateInstance<ExternalDocumentationDefinitionBuilder>(this.ServiceProvider);
    ...
    /// <inheritdoc/>
    public virtual IV3AsyncApiDocumentBuilder WithTagComponent(string name, Action<ITagDefinitionBuilder> setup)
    {
        ArgumentException.ThrowIfNullOrWhiteSpace(name);
        ArgumentNullException.ThrowIfNull(setup);
        var builder = ActivatorUtilities.CreateInstance<TagDefinitionBuilder>(this.ServiceProvider);
