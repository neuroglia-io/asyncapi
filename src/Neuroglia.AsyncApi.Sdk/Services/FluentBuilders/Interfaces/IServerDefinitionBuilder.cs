...
namespace Neuroglia.AsyncApi.Sdk.Services.FluentBuilders
{
    ...
    public interface IServerDefinitionBuilder
    {
        ...
        /// <returns>The configured <see cref="IServerDefinitionBuilder"/></returns>
        IServerDefinitionBuilder WithProtocol(string protocol, string version);
        ...
        /// <returns>The configured <see cref="IServerDefinitionBuilder"/></returns>
        IServerDefinitionBuilder AddSecurity(string name);
        ...
        /// <returns>The configured <see cref="IServerDefinitionBuilder"/></returns>
        IServerDefinitionBuilder AddBinding(IServerBindingDefinition binding);
