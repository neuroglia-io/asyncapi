...
/// <summary>
/// Represents an object used to configure an SQS topic security statement
/// </summary>
[DataContract]
public record SqsTopicSecurityStatementDefinition
{

    /// <summary>
    /// Gets/sets the type of SQS Topic. Can be either standard or FIFO.
    /// </summary>
    [DataMember(Order = 1, Name = "effect"), JsonPropertyOrder(1), JsonPropertyName("effect"), YamlMember(Order = 1, Alias = "effect")]
    public virtual SqsTopicSecurityStatementEffect Effect { get; set; }
    ...
    /// <summary>
    /// Gets/sets the SQS permission being allowed or denied e.g. sns:Publish. Can be a string or a list of string.
    /// </summary>
