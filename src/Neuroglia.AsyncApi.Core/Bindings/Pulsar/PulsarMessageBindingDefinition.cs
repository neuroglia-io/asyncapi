...
/// <summary>
/// Represents the object used to configure a Pulsar message binding
/// </summary>
[DataContract]
public record PulsarMessageBindingDefinition
    : PulsarBindingDefinition, IMessageBindingDefinition
{
