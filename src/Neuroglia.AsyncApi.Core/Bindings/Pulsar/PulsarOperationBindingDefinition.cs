...
/// <summary>
/// Represents the object used to configure a Pulsar operation binding
/// </summary>
[DataContract]
public record PulsarOperationBindingDefinition
    : PulsarBindingDefinition, IOperationBindingDefinition
{
