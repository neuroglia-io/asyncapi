...
/// <summary>
/// Represents the object used to configure a Pulsar server binding
/// </summary>
[DataContract]
public record PulsarServerBindingDefinition
    : PulsarBindingDefinition, IServerBindingDefinition
{

    /// <summary>
    /// Gets/sets the pulsar tenant. If omitted, "public" MUST be assumed.
    /// </summary>
    [DataMember(Order = 1, Name = "tenant"), JsonPropertyOrder(1), JsonPropertyName("tenant"), YamlMember(Order = 1, Alias = "tenant")]
