...
namespace Neuroglia.AsyncApi.Services.FluentBuilders
{
    ...
    public interface IChannelDefinitionBuilder
    {
        ...
        /// <returns>The configured <see cref="IChannelDefinitionBuilder"/></returns>
        IChannelDefinitionBuilder AddParameter(string name, Action<IParameterDefinitionBuilder> setup);
        ...
        /// <returns>The configured <see cref="IChannelDefinitionBuilder"/></returns>
        IChannelDefinitionBuilder UseBinding(IChannelBindingDefinition binding);
        ...
        /// <returns>The configured <see cref="IChannelDefinitionBuilder"/></returns>
        IChannelDefinitionBuilder DefineOperation(OperationType type, Action<IOperationDefinitionBuilder> setup);
        ...
        /// <param name="setup">An <see cref="Action{T}"/> used to setup the Subscribe <see cref="OperationDefinition"/></param>
        /// <returns>The configured <see cref="IChannelDefinitionBuilder"/></returns>
        IChannelDefinitionBuilder DefineSubscribeOperation(Action<IOperationDefinitionBuilder> setup);
        ...
        /// <returns>The configured <see cref="IChannelDefinitionBuilder"/></returns>
        IChannelDefinitionBuilder DefinePublishOperation(Action<IOperationDefinitionBuilder> setup);
