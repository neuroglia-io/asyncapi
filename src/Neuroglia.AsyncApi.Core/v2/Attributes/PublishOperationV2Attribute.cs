...
/// </summary>
public class PublishOperationV2Attribute
    : OperationV2Attribute
{

    /// <summary>
    /// Initializes a new <see cref="PublishOperationV2Attribute"/>
    /// </summary>
    /// <param name="messageType">The <see cref="V2OperationDefinition"/>'s message type</param>
    public PublishOperationV2Attribute(Type messageType) : base(V2OperationType.Publish, messageType) { }

    /// <summary>
    /// Initializes a new <see cref="PublishOperationV2Attribute"/>
    /// </summary>
    public PublishOperationV2Attribute() : base(V2OperationType.Publish) { }
