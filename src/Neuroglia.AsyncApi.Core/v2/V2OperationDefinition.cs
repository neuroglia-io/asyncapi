...
/// </summary>
[DataContract]
public record V2OperationDefinition
    : V2OperationTraitDefinition
{
    ...
    public virtual EquatableList<V2OperationTraitDefinition>? Traits { get; set; }
    ...
    public virtual V2OperationMessageDefinition? Message { get; set; }
