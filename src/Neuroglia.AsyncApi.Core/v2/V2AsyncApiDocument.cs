    ...
    : IAsyncApiDocument
{
    ...
    public virtual V2ApiInfo Info { get; set; } = null!;
    ...
    public virtual EquatableDictionary<string, V2ServerDefinition>? Servers { get; set; }
    ...
    public virtual EquatableDictionary<string, V2ChannelDefinition> Channels { get; set; } = null!;
    ...
    public virtual V2ComponentDefinitionCollection? Components { get; set; }
    ...
    /// <param name="operation">The resulting <see cref="V2OperationDefinition"/>, if any</param>
    /// <param name="channelName">The name of the <see cref="V2ChannelDefinition"/> the <see cref="V2OperationDefinition"/> belongs to, if any</param>
    ...
    public virtual bool TryGetOperation(string operationId, out V2OperationDefinition? operation, out string? channelName)
    {
        ...
        if (!channel.HasValue || channel.Value.Equals(default(KeyValuePair<string, V2ChannelDefinition>))) return false;
    ...
    /// <param name="operation">The resulting <see cref="V2OperationDefinition"/>, if any</param>
    /// <returns>A boolean indicating whether or not the <see cref="V2OperationDefinition"/> with the specified id could be found</returns>
    public virtual bool TryGetOperation(string operationId, out V2OperationDefinition? operation)
    {
