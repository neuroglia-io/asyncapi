...
/// <summary>
/// Represents the object used to configure a Google Pub/Sub operation binding
/// </summary>
[DataContract]
public record GooglePubSubOperationBindingDefinition
    : GooglePubSubBindingDefinition, IOperationBindingDefinition
{
