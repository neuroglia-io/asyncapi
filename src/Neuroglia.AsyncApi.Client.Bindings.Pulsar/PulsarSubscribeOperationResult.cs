...
/// <summary>
/// Represents an object used to describe the result of a Pulsar subscribe operation
/// </summary>
/// <param name="messages">An <see cref="IObservable{T}"/>, if any, used to observe incoming <see cref="IAsyncApiMessage"/>s</param>
public class PulsarSubscribeOperationResult(IObservable<IAsyncApiMessage>? messages = null)
