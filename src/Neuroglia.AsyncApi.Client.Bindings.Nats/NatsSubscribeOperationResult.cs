...
/// <summary>
/// Represents an object used to describe the result of a Nats subscribe operation
/// </summary>
/// <param name="messages">An <see cref="IObservable{T}"/>, if any, used to observe incoming <see cref="IAsyncApiMessage"/>s</param>
public class NatsSubscribeOperationResult(IObservable<IAsyncApiMessage>? messages = null)
