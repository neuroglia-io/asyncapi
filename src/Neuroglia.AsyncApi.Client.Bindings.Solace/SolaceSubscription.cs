    ...
    : IObservable<IAsyncApiMessage>, IDisposable, IAsyncDisposable
{
    ...
    /// <summary>
    /// Starts the <see cref="SolaceSubscription"/>
    /// </summary>
    /// <returns>A new awaitable <see cref="Task"/></returns>
    public virtual async Task StartAsync()
    {
        var subscriber = Context.GetSubscriber();
        await subscriber.SubscribeAsync(Session, OnMessageReceivedAsync).ConfigureAwait(false);
    }
