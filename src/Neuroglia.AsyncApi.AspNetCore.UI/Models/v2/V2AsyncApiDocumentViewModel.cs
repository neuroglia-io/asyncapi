...
/// </summary>
public record V2AsyncApiDocumentViewModel
{

    /// <summary>
    /// Initializes a new <see cref="V2AsyncApiDocumentViewModel"/>
    /// </summary>
    /// <param name="document">The <see cref="V2AsyncApiDocument"/> to render the view for</param>
    public V2AsyncApiDocumentViewModel(V2AsyncApiDocument document) => Document = document;
