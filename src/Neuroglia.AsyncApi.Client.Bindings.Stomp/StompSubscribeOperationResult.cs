...
/// <summary>
/// Represents an object used to describe the result of a Stomp subscribe operation
/// </summary>
/// <param name="messages">An <see cref="IObservable{T}"/>, if any, used to observe incoming <see cref="IAsyncApiMessage"/>s</param>
public class StompSubscribeOperationResult(IObservable<IAsyncApiMessage>? messages = null)
