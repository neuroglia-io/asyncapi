...
/// <summary>
/// Represents an object used to describe the result of a Redis subscribe operation
/// </summary>
/// <param name="messages">An <see cref="IObservable{T}"/>, if any, used to observe incoming <see cref="IAsyncApiMessage"/>s</param>
public class RedisSubscribeOperationResult(IObservable<IAsyncApiMessage>? messages = null)
